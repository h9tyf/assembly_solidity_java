...
import org.web3j.generated.contracts.Executor;
...
public class Web3App {
   ...
   public static void main(String[] args) throws Exception {
        ...
        Executor executor = Executor.deploy(web3j, credentials, new DefaultGasProvider()).send();
        System.out.println("Contract address: " + executor.getContractAddress());
